...
var BaseChartDirective = class {
  ...
  isDatasetHidden(index2) {
    var _a, _b;
    return (_b = (_a = this.chart) === null || _a === void 0 ? void 0 : _a.getDatasetMeta(index2)) === null || _b === void 0 ? void 0 : _b.hidden;
  }
  toBase64Image() {
    var _a;
...
var NgChartsModule = class _NgChartsModule {
  constructor(config) {
    ...
    const ngChartsDefaults = merge_default((config === null || config === void 0 ? void 0 : config.generateColors) ? builtInDefaults : {}, (config === null || config === void 0 ? void 0 : config.defaults) || {});
