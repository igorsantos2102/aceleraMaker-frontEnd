...
import {
  ...
  MatPrefix,
  MatSuffix
} from "./chunk-BLICJZIT.js";
import {
  FormGroupDirective,
  NgControl,
  NgForm,
  Validators
} from "./chunk-6I3I22FA.js";
import {
  CdkScrollableModule,
  ScrollDispatcher,
  ScrollingModule,
  ViewportRuler
} from "./chunk-SGW2KUPE.js";
import {
  MAT_OPTGROUP,
...
} from "./chunk-K2QDCS6W.js";
import "./chunk-5VWHK2PK.js";
import {
  ErrorStateMatcher,
  _ErrorStateTracker
} from "./chunk-42QRO5V4.js";
import {
  _isTestEnvironment
} from "./chunk-YQPKJDXX.js";
import {
...
} from "./chunk-MNCSWE53.js";
import {
  BidiModule,
  Directionality
} from "./chunk-QBA4SVF7.js";
import {
  _CdkPrivateStyleLoader,
  _bindEventWithOptions
} from "./chunk-OOXCRFBA.js";
import {
  Platform
} from "./chunk-MDTNKZNB.js";
import {
  Location,
  NgClass
...
var MatSelect = class _MatSelect {
  ...
  _initialized = new import_rxjs5.Subject();
  _cleanupDetach;
  ...
  _destroy = new import_rxjs5.Subject();
   ...
   * @docs-private
   */
  stateChanges = new import_rxjs5.Subject();
  /**
  ...
  optionSelectionChanges = (0, import_rxjs5.defer)(() => {
    const options = this.options;
    if (options) {
      return options.changes.pipe((0, import_operators3.startWith)(options), (0, import_operators3.switchMap)(() => (0, import_rxjs5.merge)(...options.map((option) => option.onSelectionChange))));
    }
  ...
  _resetOptions() {
    const changedOrDestroyed = (0, import_rxjs5.merge)(this.options.changes, this._destroy);
    ...
    (0, import_rxjs5.merge)(...this.options.map((option) => option._stateChanges)).pipe((0, import_operators3.takeUntil)(changedOrDestroyed)).subscribe(() => {
      this._changeDetectorRef.detectChanges();
      this.stateChanges.next();
    });
  }
